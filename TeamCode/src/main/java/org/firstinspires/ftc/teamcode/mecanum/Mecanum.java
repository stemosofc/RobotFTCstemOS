...
public class Mecanum extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            hard.braco.setPower(gamepad2.left_stick_y);
            ...
            if(gamepad2.a) {
                hard.intake.setPower(-1.0);
                hard.conveyor.setPower(-1);
            }

            if(gamepad2.y) {
                hard.intake.setPower(0);
                hard.conveyor.setPower(0);
            }
            if(gamepad2.b) {
                hard.conveyor.setPower(1);
                hard.intake.setPower(1);
            }
            if(gamepad2.x) {
                hard.conveyor.setPower(0.6);
            }
